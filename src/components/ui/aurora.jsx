...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    const colorStopsArray = colorStops.map(hex => {
      // Strip alpha channel if present (8-char hex codes like #RRGGBBAA)
      const hexWithoutAlpha = hex.length === 9 ? hex.slice(0, 7) : hex;
      const c = new Color(hexWithoutAlpha);
      return [c.r, c.g, c.b];
    });
    ...
    const update = (t) => {
      ...
      const currentTime = propsRef.current.time !== undefined ? propsRef.current.time : t * 0.01;
